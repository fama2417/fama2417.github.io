...
create table public.report_key_images (
...
create index report_key_images_appointment_idx on public.report_key_images (appointment_id, created_at);
...
create function private.protect_key_images() returns trigger
