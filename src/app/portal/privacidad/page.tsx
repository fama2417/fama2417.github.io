...
export default function PhrPrivacyPage() {
  return <main className="portal-shell"><article className="card portal-card legal-content">
    ...
    <h2>Procesamiento automatizado</h2><p>Los PDF se leen localmente y nunca se envían al proveedor de inteligencia artificial. Las fotografías JPG/PNG sí pueden procesarse visualmente cuando eliges analizarlas. Si solicitas resolver códigos LOINC, se envía sólo una lista compacta de analitos, unidades y muestras, nunca el PDF. El archivo original no se modifica, cada sugerencia exige tu confirmación y los resultados no constituyen diagnóstico ni indicación médica.</p>
